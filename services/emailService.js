...
export const verifyAccountEmail = (email, verificationToken) => {
  ...
  return {
    ...
    to: email,
    subject: "Verify your Blog-Platform account",
    html: `
...
export const accountDeletionConfirm = (email, username) => ({
  from: ` <${process.env.SENDGRID_SENDER_EMAIL}>`,
  to: email,
  subject: "Blog-Platform Account Deletion",
...
export const successfulAdminCreation = (email, username, password) => ({
  from: ` <${process.env.SENDGRID_SENDER_EMAIL}>`,
  to: email,
  subject: "Blog-Platform Admin creation",
  html: ` <p>Hi <strong>${username},</strong></p>
          <p>This is to confirm that your admin account has been successfully created</p>
